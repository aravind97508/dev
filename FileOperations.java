...
//	List<String> fileList = new ArrayList<String>(List.of("demo1","demo2","demo3","demo4"));
	static final String path = "C:\\JAVAFSDS\\JAVAFSDS";
	
	FileOperations(){
		System.out.println("WELCOME TO COMPANY LOCKERS VIRTUAL REPOSITORIES!!");
		System.out.println("DEVELOPED BY ARAVIND PILLAI");
